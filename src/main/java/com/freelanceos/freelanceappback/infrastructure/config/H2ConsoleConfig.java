package com.freelanceos.freelanceappback.infrastructure.config;
...
public class H2ConsoleConfig {
    ...
    public ServletRegistrationBean<Servlet> h2ConsoleServletRegistration(
        ...
        try {
            ...
            ServletRegistrationBean<Servlet> registration = new ServletRegistrationBean<>(servlet, mapping);
